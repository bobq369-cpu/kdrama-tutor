...
def inject_custom_css():
    # ============================================================
    # 🎛️ [사장님 전용 리모컨] - 여기서 숫자를 바꿔보세요!
    # ============================================================
    # 💡 꿀팁:
    # - Y축(위아래): "-" 마이너스를 붙이면 위로 올라갑니다. (예: "-50px")
    #               그냥 숫자면 아래로 내려갑니다. (예: "50px")
    # - X축(좌우): "-" 마이너스는 왼쪽, 그냥 숫자는 오른쪽입니다.
    # ============================================================
    
    # [1] 전체 화면 상단 여백 (0px 추천)
    ...
    prompt_x = "0px"
    prompt_y = "0px"   # 아래로 내리려면 "50px", 위로 올리려면 "-50px"

    # [6] 추천 표현 바 위치
    smart_x = "0px"
    smart_y = "-20px"  # 👈 (중요) 채팅창과 겹치지 않게 살짝 위로 띄움
